...
#docker run --name jenkins-container -p 8080:8080 -p 50000:50000 -d  -e DOCKER_HOST=tcp://host.docker.internal:2375 -v C:\jenkins-home:/var/jenkins_home jenkins/docker:latest